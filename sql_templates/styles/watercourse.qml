...
<qgis readOnly="0" minScale="1e+08" simplifyDrawingHints="1" simplifyDrawingTol="1" labelsEnabled="0" maxScale="0" simplifyMaxScale="1" simplifyAlgorithm="0" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" version="3.6.0-Noosa" simplifyLocal="1">
  <flags>
  ...
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" type="categorizedSymbol" attr="size">
    <categories>
      <category render="true" label="Major River" symbol="0" value="Major River"/>
      <category render="true" label="Minor River" symbol="1" value="Minor River"/>
      <category render="true" label="Stream" symbol="2" value="Stream"/>
      <category render="true" label="Other" symbol="3" value="Other"/>
    </categories>
    <symbols>
      <symbol clip_to_extent="1" force_rhr="0" alpha="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" enabled="1" locked="0">
          ...
          <prop v="38,130,191,255" k="line_color"/>
  ...
  <DiagramLayerSettings zIndex="0" showAll="1" placement="2" obstacle="0" linePlacementFlags="18" priority="0" dist="0">
    <properties>
      <Option type="Map">
        <Option type="QString" value="" name="name"/>
        <Option name="properties"/>
  ...
  <defaults>
    ...
    <default field="size" expression="''Other''" applyOnUpdate="0"/>
