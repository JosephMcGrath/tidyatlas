...
<qgis labelsEnabled="0" minScale="1e+08" simplifyDrawingHints="1" simplifyLocal="1" simplifyMaxScale="1" simplifyDrawingTol="1" version="3.6.0-Noosa" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyAlgorithm="0" styleCategories="AllStyleCategories" readOnly="0">
  ...
  <renderer-v2 forceraster="0" type="categorizedSymbol" attr="category" enableorderby="0" symbollevels="0">
    <categories>
      <category render="true" label="Continental" value="Continental" symbol="0"/>
      <category render="true" label="Oceanic" value="Oceanic" symbol="1"/>
      <category render="true" label="Undefined" value="" symbol="2"/>
    </categories>
    <symbols>
      <symbol clip_to_extent="1" name="0" type="fill" force_rhr="0" alpha="1">
        <layer enabled="1" locked="0" pass="0" class="SimpleFill">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="217,119,119,255" k="color"/>
  ...
  <aliases>
    ...
    <alias name="" field="category" index="1"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" field="modified" constraints="0" notnull_strength="0" unique_strength="0"/>
  </constraints>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer groupBox="1" visibilityExpression="" name="" showLabel="1" columnCount="1" visibilityExpressionEnabled="0">
      <attributeEditorField name="category" showLabel="1" index="1"/>
