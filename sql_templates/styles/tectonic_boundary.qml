...
<qgis simplifyLocal="1" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyDrawingTol="1" labelsEnabled="0" simplifyMaxScale="1" minScale="1e+08" styleCategories="AllStyleCategories" version="3.6.0-Noosa" simplifyAlgorithm="0" simplifyDrawingHints="0" readOnly="0">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" type="categorizedSymbol" forceraster="0" attr="category">
    <categories>
      <category symbol="0" value="Convergant" label="1 - Convergant" render="true"/>
      <category symbol="1" value="Divergent" label="2 - Divergent" render="true"/>
      <category symbol="2" value="Transform (Sinistral)" label="3 - Transform (Sinistral)" render="true"/>
      <category symbol="3" value="Transform (Dextral)" label="4 - Transform (Dextral)" render="true"/>
      <category symbol="4" value="" label="Unclassified" render="true"/>
    </categories>
    <symbols>
            ...
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="angle">
                  ...
                  <Option type="QString" value="(&quot;direction&quot; + 180.0) % 360" name="expression"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="angle">
                  <Option type="bool" value="true" name="active"/>
                  <Option type="QString" value="&quot;direction&quot; % 360" name="expression"/>
                  <Option type="int" value="3" name="type"/>
                </Option>
              </Option>
              <Option type="QString" value="collection" name="type"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="angle">
                  <Option type="bool" value="true" name="active"/>
                  <Option type="QString" value="(&quot;direction&quot; + 90.0) % 360" name="expression"/>
                  <Option type="int" value="3" name="type"/>
                </Option>
              </Option>
              <Option type="QString" value="collection" name="type"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="angle">
                  <Option type="bool" value="true" name="active"/>
                  <Option type="QString" value="(&quot;direction&quot; + 270.0) % 360" name="expression"/>
                  <Option type="int" value="3" name="type"/>
                </Option>
              </Option>
              <Option type="QString" value="collection" name="type"/>
  ...
  <aliases>
    ...
    <alias field="category" index="1" name=""/>
    <alias field="direction" index="2" name=""/>
    <alias field="uuid" index="3" name=""/>
    <alias field="created" index="4" name=""/>
    <alias field="modified" index="5" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="category" exp_strength="0" constraints="0" notnull_strength="0"/>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column hidden="0" width="-1" type="field" name="category"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="classication"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="classication"/>
