...
<qgis version="3.8.3-Zanzibar" simplifyDrawingHints="1" simplifyDrawingTol="1" readOnly="0" simplifyAlgorithm="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" minScale="1e+08" labelsEnabled="0" simplifyLocal="1" maxScale="0" styleCategories="AllStyleCategories">
  ...
  <renderer-v2 type="categorizedSymbol" forceraster="0" enableorderby="1" attr="type" symbollevels="0">
    <categories>
      <category label="Door" value="Door" symbol="0" render="true"/>
      <category label="Door (locked)" value="Door (locked)" symbol="1" render="true"/>
      <category label="Step" value="Step" symbol="2" render="true"/>
      <category label="Wall" value="Wall" symbol="3" render="true"/>
    </categories>
    <symbols>
...
END</orderByClause>
  ...
  <DiagramLayerSettings obstacle="0" showAll="1" linePlacementFlags="18" dist="0" priority="0" zIndex="0" placement="2">
    <properties>
      <Option type="Map">
        <Option type="QString" name="name" value=""/>
        <Option name="properties"/>
  ...
  <defaults>
    ...
    <default field="type" expression="''Wall''" applyOnUpdate="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer visibilityExpression="" name="" columnCount="1" showLabel="1" groupBox="1" visibilityExpressionEnabled="0">
      <attributeEditorField name="type" index="1" showLabel="1"/>
