...
<qgis simplifyMaxScale="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" version="3.4.3-Madeira" readOnly="0" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyDrawingTol="1" minScale="1e+08" simplifyLocal="1" simplifyDrawingHints="1">
  ...
  <labeling type="simple">
    <settings>
      <text-style fontItalic="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" useSubstitutions="0" fieldName="name" textOpacity="1" fontSize="10" isExpression="0" fontSizeUnit="Point" fontFamily="Arial" multilineHeight="1" fontLetterSpacing="0" fontCapitals="0" fontWordSpacing="0" fontWeight="50" textColor="0,0,0,255" namedStyle="Regular" previewBkgrdColor="#ffffff" blendMode="0" fontStrikeout="0">
      ...
      <text-format wrapChar="" formatNumbers="0" decimals="3" autoWrapLength="15" addDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" placeDirectionSymbol="0" plussign="0" multilineAlign="1" leftDirectionSymbol="&lt;" rightDirectionSymbol=">" reverseDirectionSymbol="0"/>
      <placement quadOffset="4" rotationAngle="0" priority="5" preserveRotation="1" repeatDistance="0" fitInPolygonOnly="0" centroidInside="0" dist="0" placement="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" offsetUnits="MM" offsetType="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM" centroidWhole="0" xOffset="0" yOffset="0" placementFlags="10" maxCurvedCharAngleOut="-25" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25"/>
